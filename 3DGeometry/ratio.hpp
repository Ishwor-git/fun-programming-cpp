...
public:
    Ratio2(void);
    Ratio2(float, float);
    friend ostream &operator<<(ostream &, Ratio2 &);
...
public:
    ...
    friend ostream &operator<<(ostream &, Ratio3 &);
};
...
ostream &operator<<(ostream &out, const Ratio2 &r)
{
    out << r.getM1() << " / " << r.getM2();
    // out << r.m1 << " / " << r.m2;
    return out;
...
ostream &operator<<(ostream &out, const Ratio3 &r)
{
